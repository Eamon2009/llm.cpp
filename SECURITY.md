...
llm.cpp is a local-first transformer project. The repository includes native C++ code, Python inference and training code model checkpoints, and sample datasets. Security reports are welcome, especially when they affect local execution, dependency safety, or handling of model/data files.
...
- Whether the issue requires a crafted model, dataset, prompt or environment variable.
